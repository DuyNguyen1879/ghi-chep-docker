...
Có thể hiểu một cách cơ bản, docker là ảo hóa ở tầng ứng dụng. Nghĩa là nó đóng gói mọi thứ (thư viện, môi trường) để một ứng dụng có thể chạy bình thường mà không cần cài đặt thêm bất cứ thứ gì. Các gói được đóng này gọi là Image, từ image ta sẽ tạo ra các container. Trên một HĐH đang sử dụng, bạn có thể chạy cùng lúc vài Container về MySQL với các version khác nhau để so sánh tính năng. Việc này rất khó thực hiện nếu bạn cài trực tiếp MySQL trên OS đang sử dụng.
...
- Cài đặt Docker CE
    ...
    - Cập nhật các package và cài đặt một số package cần thiết
    ...
    - Thêm GPG key của Docker's official
    
    ```sh
    curl -fsSL https://download.docker.com/linux/ubuntu/gpg | sudo apt-key add -
    ```
    
    - Thiết lập repo stable để cài đặt
